                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <form action="<?php echo site_url('product/edit').'?id='.$p['id_sanpham']; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
						    <label for="slcType">Chọn loại quần áo</label>
						    ...
						    <select name="slcBrand" class="form-control"> 
						  	...
						  	<div class="form-group">
                                ...
                                <select name="slcGT" class="form-control">
                                    <option value="1" <?php echo ($p['sex'] == 1)?'selected="selected"':""; ?> >Nam</option>
                                    <option value="0" <?php echo ($p['sex'] == 0)?'selected="selected"':""; ?> >Nữ</option>
                                </select>
                            </div>
