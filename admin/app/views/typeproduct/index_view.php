    ...
    <div class="row">
        <div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="main-content">
                ...
                <?php } ?>
                <div class="col-lg-3">
                    <a href="<?php echo site_url('typeproduct/add') ?>" title="" class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i>  Thêm loại quần áo</a>
                ...
                <table class="table table-striped">
                    ...
                    foreach ($info as $key => $val):
                        ...
                        <tr>
                            ...
                            <td><?php echo ($val['gioitinh']==1)?"Nam":"Nữ"; ?></td>
